...
function shuffle() {
    ...
    switch (operator) {
        ...
        case "Glaz":
            ...
            Secondary = randomizeLoadout("PMM", "GONNE-6")
            switch (Secondary){
                case "PMM":
                    SecondaryGrip = ""
                    SecondaryScope = ""
        ...
        case "Dokkaebi":
            ...
            Secondary = randomizeLoadout("GONNE-6", "SMG-12")
            switch (Secondary){
                case "GONNE-6":
                    SecondaryGrip = ""
                    SecondaryScope = ""
        ...
        case "Lion":
            ...
            Secondary = randomizeLoadout("GONNE-6", "LFP586")
            switch (Secondary){
                case "GONNE-6":
                    SecondaryGrip = ""
                    SecondaryScope = ""
        ...
        case "Finka":
            ...
            Secondary = randomizeLoadout("GONNE-6", "PMM")
            switch (Secondary){
                case "GONNE-6":
                    SecondaryGrip = ""
                    SecondaryScope = ""
        ...
        case "Gridlock":
            ...
            Secondary = randomizeLoadout("Super Shorty","GONNE-6")
            switch (Secondary){
                case "GONNE-6":
                    SecondaryGrip = ""
                    SecondaryScope = ""
        ...
        case "Amaru":
            ...
            Secondary = randomizeLoadout("GONNE-6","SMG11")
            switch (Secondary){
                case "GONNE-6":
                    SecondaryGrip = ""
                    SecondaryScope = ""
        ...
        case "Kali":
            ...
            Secondary = randomizeLoadout("C75 Auto","SPSMG9")
            switch (Secondary){
                case "SPSMG9":
                    SecondaryGrip = ""
                    SecondaryScope = randomizeLoadout(SecondaryScopeArray[random(SecondaryScopeArray.length)])
        ...
        case "Clash":
            ...
            Secondary = randomizeLoadout("Super Shorty", "SPSMG9")
            switch (Secondary){
                case "SPSMG9":
                    SecondaryGrip = ""
                    SecondaryScope = randomizeLoadout(SecondaryScopeArray[random(SecondaryScopeArray.length)])
